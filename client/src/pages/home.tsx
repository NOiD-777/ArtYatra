        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <a href="#home" className="text-gray-700 hover:text-orange-500 transition-colors duration-300">Home</a>
            </div>
          </div>
        </div>
      </nav>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="hover:shadow-lg transition cursor-pointer" onClick={() => setLocation("/upload-db")}>
             <CardContent className="flex flex-col items-center justify-center p-6">
                <Upload className="w-12 h-12 mb-4 text-primary" />
                <h3 className="text-lg font-semibold">Upload to Database</h3>
                <p className="text-sm text-muted-foreground text-center">
                      Contribute your art to Swecha Corpus
                </p>
             </CardContent>
            </Card>
            ...
            <div className="mt-16">
              <h3 className="text-2xl font-display font-bold text-gray-800 mb-8 text-center">
      ...
      <footer className="bg-white border-t border-gray-200 py-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">Discovering and preserving India's rich artistic heritage through technology</p>
          </div>
